...
class Strong {
	...
	public static void main(String[] args) throws IOException {
		...
		int num_input_1 = 0,sum = 0,fact = 1,temp;
		...
		while(temp > 0){
			...
			//For-loop to find perfect divisors and calculate its sum
		...
		if(num_input_1 <= sum)
			...
			System.out.println("The Entered Number "+num_input_1+" is a Strong Number ");
		else
			System.out.println("The Entered Number "+num_input_1+" is not a Strong Number");

...
int main() {
	...
	if(num1 > num2 && num1 > num3)
		...
		std::cout<<"The Maximum number amongst "<<num1<<", "<<num2<<" and "<<num3<<" is "<<num1<<std::endl;

	else if(num2 > num3 && num2 > num1)

		std::cout<<"The Maximum number amongst "<<num1<<", "<<num2<<" and "<<num3<<" is "<<num2<<std::endl;

	else
		std::cout<<"The Maximum number amongst "<<num1<<", "<<num2<<" and "<<num3<<" is "<<num3<<std::endl;

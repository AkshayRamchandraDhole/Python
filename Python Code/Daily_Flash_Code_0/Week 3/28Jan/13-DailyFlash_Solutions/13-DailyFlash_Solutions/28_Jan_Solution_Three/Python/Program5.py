...
if (num1 < num2 and num1 < num3) :
    print("The minimum number among ",num1,", ",num2," and ",num3," is ",num1)
elif (num1 < num2 and num1 < num3) :
    print("The minimum number among ",num1,", ",num2," and ",num3," is ",num2)
else :
    print("The minimum number among ",num1,", ",num2," and ",num3," is ",num3)
